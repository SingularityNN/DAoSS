...
function renderNodeControls(node) {
    ...
    document.getElementById('flowchart-canvas').appendChild(controls);
}
...
function renderInfoPanel() {
    ...
    document.getElementById('node-x-input').value = Math.round(node.x);
    document.getElementById('node-y-input').value = Math.round(node.y);
    document.getElementById('node-code-input').value = node.codeReference || '';
}
...
function renderComments() {
    ...
    document.getElementById('comment-node-name').textContent = node.text;
...
function updateNode() {
    ...
    node.codeReference = document.getElementById('node-code-input').value;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Info panel
    document.getElementById('save-node-btn').addEventListener('click', updateNode);
